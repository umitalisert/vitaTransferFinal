        ...
        <View style={styles.container}>
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.body}>
                    <VText bold style={styles.title}>{cultureStore.culture == 'tr' ? 'Dil Seçimi' : cultureStore.culture=='en' ? 'Language Preferences' : cultureStore.culture == 'de' ? 'Spracheinstellungen' :  'Dil Seçimi'}</VText>
