...
const MyCarComponent = ({ navigation, item, keyItem  , cultureResource}) => {
    const windowWidth = Dimensions.get('window').width;
    // const windowHeight = Dimensions.get('window').height;
    return (
        <View key={keyItem} style={{ flexDirection: 'row' , flex:1 , }}>
            <View style={{ flex:1,backgroundColor: Color.white,marginHorizontal:20, borderRadius: 10, borderWidth: 1, borderColor: Color.greyBorder, paddingVertical: 16, paddingHorizontal: 15, shadowColor: '#000', shadowOffset: { width: 0, height: 2, }, shadowOpacity: 0.25, shadowRadius: 4, elevation: 5,  }}>
